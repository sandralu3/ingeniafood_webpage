-- Imagenes de portada para el banco de recetas del sistema (Unsplash).
...
update public.recipes
set
  image_url = 'https://images.unsplash.com/photo-1577805947697-89e18249d767?auto=format&fit=crop&w=800&q=80',
  updated_at = now()
