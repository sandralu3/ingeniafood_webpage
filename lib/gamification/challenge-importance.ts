...
const SYSTEM_CHALLENGE_IMPORTANCE: Record<string, string> = {
  ...
  "3": "Sumar vegetales aporta fibra, vitaminas y antioxidantes que protegen tu salud a largo plazo.",
  ...
  "6": "Un desayuno con proteína te da energía sostenida y evita picos de hambre a media mañana.",
