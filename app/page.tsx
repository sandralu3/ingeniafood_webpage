...
export default function LandingPage() {
  ...
  const landingHtml = useMemo(
    () =>
      applyLandingI18n(LANDING_HTML, {
        ...
        heroCtaGuide: t("hero.ctaGuide"),
        heroCtaSocial: t("hero.ctaSocial"),
        heroImageAlt: t("hero.imageAlt"),
        appBadge: t("app.badge"),
        appTitle: t("app.title"),
        appSubtitle: t("app.subtitle"),
        appCardTitle: t("app.cardTitle"),
        appCardBody: t("app.cardBody"),
        socialTitle: t("social.title"),
        socialSubtitle: t("social.subtitle"),
        instagramReelTitle: t("social.reelTitle"),
        socialCta: t("social.cta"),
        socialNote: t("social.note"),
        benefitsTitle: t("benefits.title"),
        benefit1Title: t("benefits.item1Title"),
        benefit1Body: t("benefits.item1Body"),
        benefit2Title: t("benefits.item2Title"),
        benefit2Body: t("benefits.item2Body"),
        benefit3Title: t("benefits.item3Title"),
        benefit3Body: t("benefits.item3Body"),
        guideTitlePrefix: t("guide.titlePrefix"),
        guideTitleAccent: t("guide.titleAccent"),
        guideSubtitle: t("guide.subtitle"),
        guideBullet1: t("guide.bullet1"),
        guideBullet2: t("guide.bullet2"),
        guideBullet3: t("guide.bullet3"),
        guideFreeBadge: t("guide.freeBadge"),
        guideMeta: t("guide.meta"),
        guideDownload: t("guide.download"),
        guideImageAlt: t("guide.imageAlt"),
        guideBadgePdf: "PDF",
        guideBadgeFast: t("guide.badgeFast"),
  ...
  useEffect(() => {
    ...
    const frame = window.requestAnimationFrame(() => {
      setLangSlot(document.getElementById("marketing-lang-root"));
    });
