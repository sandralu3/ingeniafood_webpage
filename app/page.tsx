...
export default function LandingPage() {
  const landingHtml = useMemo(() => {
    ...
    return LANDING_HTML
      .replace('href="/descargar-app">Descargar App</a>', 'href="#preview">Descarga Guía de Cenas (PDF)</a>')
      .replaceAll('href="#app-beta">App</a>', 'href="#preview">Guía gratis</a>');
  }, []);
